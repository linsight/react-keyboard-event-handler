...
var _KeyboardEventHandler = __webpack_require__(17);

var _KeyboardEventHandler2 = _interopRequireDefault(_KeyboardEventHandler);

var _reactProvideState = __webpack_require__(22);
...
var _keyEvents = __webpack_require__(21);
...
var numberKeys = '0123456789'.split('').reduce(function (accumulator, current, index) {
  return Object.assign(accumulator, _defineProperty({}, current, [index + 48, index + 96]));
}, {});
...
function matchKeyEvent(event, keyName) {
  ...
  var keyNameParts = cleanKeyName === '+' ? ['+'] : cleanKeyName.split(/\s?\+\s?/); // e.g. 'crtl + a'
...
exports.default = function (_ref) {
  ...
  return function (Component) {
    var stateNamespace = namespace || 'defaultNamespace';
    var stateName = name || 'defaultName';
    ...
    var ComponentWithState = function (_React$Component) {
      ...
      function ComponentWithState(props) {
        ...
        var value = registry.getState(stateNamespace, stateName);
        ...
        _this.state = _defineProperty({}, stateName, value);
        return _this;
      }
      ...
      _createClass(ComponentWithState, [{
        ...
        value: function handleStateChange(newValue) {
          ...
          this.setState(_defineProperty({}, stateName, newValue));

          if (updateRegistry) {
            var handlers = registry.getHandlers(stateNamespace, stateName);
        ...
        value: function render() {
          ...
          var propName = alias || stateName;
          var handlerName = 'set' + propName.replace(propName[0], propName[0].toUpperCase());
          var stateProps = propName ? (_ref2 = {}, _defineProperty(_ref2, propName, this.state[stateName]), _defineProperty(_ref2, handlerName, this.handleStateChange), _ref2) : {};
